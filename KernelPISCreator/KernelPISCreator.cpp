...
__stdcall PicStart(UINT64 StartContext)
{
	...
	UNICODE_STRING rtlInitUnicodeString = RTL_CONSTANT_STRING(RtlInitUnicodeStringString);
	UNICODE_STRING driverObjectName = RTL_CONSTANT_STRING(pisParameters->DriverObjectName);
	...
	RtlInitUnicodeString(&driverObjectName, (PCWSTR)(UINT_PTR)(pisParameters->DriverObjectName));
